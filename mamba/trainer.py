...
from mamba.models.temporal import Temporal
...
class Trainer(object):
    def __init__(
        ...
        headless: bool = True,
        rank_bins: int = 10,
        robot: MambaRobot = None,
        diffusion_var: str = "multi",
        ...
        self._optimizer = torch.optim.AdamW(mamba_model.parameters(), lr=train_lr)
