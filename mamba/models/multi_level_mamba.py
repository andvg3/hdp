...
class MultiLevelMamba(nn.Module):
    ...
    def __init__(
        ...
        mamba_optim: bool = True,
        mamba_optim_steps: int = 50,
        mamba_lr: float = 0.1,
        ...
        Parameters:
            models (Dict[str, SimpleModel]): A dictionary of models.
            mamba_optim (bool, optional): Flag indicating whether differentiable optimization should be used. Defaults to True.
            mamba_optim_steps (int, optional): The number of differentiable optimization steps. Defaults to 50.
            mamba_lr (float, optional): The learning rate for differentiable optimization. Defaults to 0.1.
        ...
        self._mamba_optim = mamba_optim
        self._mamba_optim_steps = mamba_optim_steps
        self._mamba_lr = mamba_lr
        ...
        if self._mamba_optim:
            ...
            for _ in range(self._mamba_optim_steps):
                (
                    ...
                    last_joints, last_poses, self._mamba_lr / 10
                )
